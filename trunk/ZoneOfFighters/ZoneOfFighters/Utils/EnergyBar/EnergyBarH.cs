...
namespace ZoneOfFighters.Utils.EnergyBar
{
    class EnergyBarH : EnergyBar
    {
        ...
        public EnergyBarH(Texture2D boxTexture, Texture2D energyTexture, Vector2 boxPosition, Vector2 energyPosition)
        ...
        public EnergyBarH(Texture2D boxTexture, Texture2D energyTexture, Vector2 boxPosition, Vector2 energyPosition, Color color)
        ...
        public EnergyBarH(Texture2D boxTexture, Texture2D energyTexture, Vector2 boxPosition, Vector2 energyPosition, Color emptyEnergyColor, Color fullEnergyColor)
        ...
        public EnergyBarH(Texture2D boxTexture, Texture2D energyTexture, Vector2 boxPosition, Vector2 energyPosition, Color emptyEnergyColor, Color fullEnergyColor, bool flipEnergyReduce)
        ...
        public EnergyBarH(Texture2D boxTexture, Texture2D energyTexture, Vector2 boxPosition, Vector2 energyPosition, bool recoveryBar, float recoveryFactor)
        ...
        /// <param name="recoveryBar">Ativa ou não a barra de recuperação de energia</param>
        /// <param name="recoveryFactor">Fator de recuperação de energia</param>
        public EnergyBarH(Texture2D boxTexture, Texture2D energyTexture, Vector2 boxPosition, Vector2 energyPosition, Color emptyEnergyColor, Color fullEnergyColor, bool recoveryBar, float recoveryFactor)
        ...
        /// <param name="recoveryFactor">Fator de recuperação de energia</param>
        /// <param name="flipEnergyReduce">Reduz a barra de energia para o lado inverso</param>
        public EnergyBarH(Texture2D boxTexture, Texture2D energyTexture, Vector2 boxPosition, Vector2 energyPosition, Color emptyEnergyColor, Color fullEnergyColor, bool recoveryBar, float recoveryFactor, bool flipEnergyReduce)
